...
import { cocktailLists, type Cocktail } from "../../constants/constants";
import { mockTailLists } from "../constants/constants";
    ...
    <section id="cocktails" className="noisy">
      ...
      <div className="list">
        <div className="popular">
          ...
          <ul>
            {cocktailLists.map((cocktail: Cocktail) => (
        ...
        <div className="loved">
          ...
          <ul>
            {mockTailLists.map((cocktail: Cocktail) => (
              <li key={cocktail.name}>
                <div className="md:me-28">
                  <h3>{cocktail.name}</h3>
                  <p>
